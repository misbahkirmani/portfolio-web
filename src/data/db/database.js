...
const database = {
  ...
  services: [
    ...
    },
    {
      ...
      icon: "mobile",
      details:
        "Making things as simple as possible from lo-fi wireframes to hi-fi products.",
    },
  ],
  reviews: [
    {
      id: 1,
      content:
        "Very great job and amazing result,so convenient and I highly recommend them,straight forward and so accurate , I'm extremely happy with the job that they have done.Thank you Web Artisans for the great job and I will definitely hire you for the future projects.",
      author: {
    ...
    },
    {
      id: 2,
      content:
        "It was wonderful to work with Web Artisans,it was my second project with them.They are fast,reliable and very professional.Will surely hire them again in future",
      author: {
        name: "Rohit Redhu",
        designation: "Client",
      },
    },
    {
      id: 3,
      content:
        "Web Artisans are a delight to work with.Understood the project from start to finish and even went an extra mile in comming up with an extra feature that would make the app more appealing to my visitors.Any future projects I would go straight to these guys.",
      author: {
        name: "Don Alm",
        designation: "Client",
      },
  ...
  portfolios: [
    {
      ...
      title: "Kids'O Clock",
      subtitle:
        "Kids O' Clock is a platform created for parents to sell/buy kids clothes and accesories or books, toys etc.",
      imageUrl:
    ...
    },
    {
      ...
      title: "Officeable",
      subtitle:
        "Short-term rental marketplace for offices, meeting rooms, and more! Find a quiet professional setting for an important Zoom call, or turn your underutilized office space into income in 5 minutes.",
      imageUrl:
    ...
    // },
    {
      ...
      title: "Attractr",
      subtitle:
        "Place where an indivisual or a group can list the events which they are organizing, schedules,pictures and other datails etc. People can go to the listing and book a place in the event. We are still working on this project.",
      imageUrl:
    ...
    // },
    {
      ...
      title: "Adepty",
      subtitle:
        "Adepty is a place where indivisuals can list their skills or services. People can go to the website, and buy the services.",
      imageUrl:
    ...
    // },
    {
      ...
      imageUrl:
        "https://res.cloudinary.com/dugd1qi5v/image/upload/v1671616649/Screen_Shot_2022-12-21_at_1.16.56_PM_p1z4sx.png",
      largeImageUrl: [
        "https://res.cloudinary.com/dugd1qi5v/image/upload/v1671616649/Screen_Shot_2022-12-21_at_1.16.56_PM_p1z4sx.png",
      ],
    ...
    },
    {
      ...
      subtitle: "Website Design.",
      imageUrl:
        "https://res.cloudinary.com/dugd1qi5v/image/upload/v1673266814/Screen_Shot_2022-12-21_at_1.17.16_PM_tba98v.png",
      largeImageUrl: [
        "https://res.cloudinary.com/dugd1qi5v/image/upload/v1673266814/Screen_Shot_2022-12-21_at_1.17.16_PM_tba98v.png",
      ],
    ...
    },
    {
      ...
      subtitle: "Website Design.",
      imageUrl:
        "https://res.cloudinary.com/dugd1qi5v/image/upload/v1673267018/Screen_Shot_2023-01-09_at_4.22.35_PM_cjipsi.png",
      largeImageUrl: [
        "https://res.cloudinary.com/dugd1qi5v/image/upload/v1673267018/Screen_Shot_2023-01-09_at_4.22.35_PM_cjipsi.png",
      ],
    },
